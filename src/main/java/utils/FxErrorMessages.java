...
public class FxErrorMessages {
    ...
    public static String STUDENT_NON_EXISTING = "No Student exists for this Student ID";
    public static String STUDENT_ALREADY_ADDED = "This Student ID is already a member of a Team, please enter a non-added member";
